...
func newDoctorCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example: `  assist-pp-cli doctor
  assist-pp-cli doctor --json
  assist-pp-cli doctor --fail-on warn
  assist-pp-cli doctor --fail-on stale`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			report["auth"] = "none (anonymous public endpoints)"
			report["env_vars"] = "OK no credentials required"
