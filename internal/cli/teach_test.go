...
func withTempLearnHome(t *testing.T) string {
	...
	t.Setenv("ASSIST_STATE_DIR", "")
	t.Setenv("ASSIST_HOME", "")
...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"assist-pp-cli auth login",
		"assist-pp-cli doctor",
		"assist-pp-cli help items",
		"assist-pp-cli sync",
		"assist-pp-cli profile list",
		"assist-pp-cli feedback list",
		"assist-pp-cli which",
		"assist-pp-cli agent-context",
		"assist-pp-cli completion bash",
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		"assist-pp-cli teach",
		"assist-pp-cli recall",
		"assist-pp-cli learnings",
		"assist-pp-cli teach-pattern",
		"assist-pp-cli teach-lookup",
		"assist-pp-cli items list",
	}
...
func TestSkipLearnHook_FrameworkCommandsDoNotCreateDefaultDB(t *testing.T) {
	...
	for _, args := range cases {
		...
		if _, err := os.Stat(defaultDBPath("assist-pp-cli")); err == nil {
